...
import { StyledButton,
         ...
         StyledSelect,
         StyledSmallText,
         Styledh2 } from '../Styles'
import { fetchBeerPage,
         fetchCategories, 
         deselectBeer, 
         postSomething,
         deleteSomething
...
const InputRepeater = props => {
    ...
    //display info as text by default
        return (
            ...
            return (
            <StyledInputRegion key={i}>
            <h3>{str.toUpperCase().replace(/_/g, " ")}:</h3><p>{props.value[str]}</p>
            </StyledInputRegion>
            )}))}
}
    ...
    return (
        ...
        <StyledSelect value={props.value} onChange={props.handleChange}>
            ...
            {props.categories
                ...
                .map(c => <option key={c.name} value={c.url}>{c.name}</option>)}
        </StyledSelect>
    ...
    if(props.editing && props.selectedBeer) {
        return (
            <StyledInputRegion>    
                    ...
                    <StyledButton color={'light'} onClick={props.handleEditClick}>Cancel</StyledButton>

                    <StyledButton color={'delete'} onClick={props.handleDeleteClick}>Delete Beer</StyledButton>
                <div>
        ...
        return (
            <StyledInputRegion>
                <StyledButton onClick={props.handleEditClick}>Edit this Entry</StyledButton>
            </StyledInputRegion>
        )
    }
}
                    ...
                    <StyledInputRegion>
                        <StyledBeerInputs>
                            ...
                            <CategoryOptions
                                ...
                                value={this.state.optionState || this.props.selectedBeer.category || ''}
